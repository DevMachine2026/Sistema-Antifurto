# Documentação Olho Vivo

| Documento | Público | Descrição |
|-----------|---------|-----------|
| [`../README.md`](../README.md) | Desenvolvedores | Visão técnica, deploy, arquitetura |
| [`../MANUAL_IMPLANTACAO_RESTAURANTE.md`](../MANUAL_IMPLANTACAO_RESTAURANTE.md) | Dono / gestor / implantação | Instalação do agente, câmeras, painel |
